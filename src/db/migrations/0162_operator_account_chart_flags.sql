-- Operator chart: is_product, uses_platform_collection_gl, type (Bukku-style) per business spec.
-- Run: node scripts/run-migration.js src/db/migrations/0162_operator_account_chart_flags.sql
...
UPDATE account SET is_product = 1, uses_platform_collection_gl = 1, type = 'REVENUE', updated_at = NOW()
WHERE id = 'e1b2c3d4-2004-4000-8000-000000000304';

UPDATE account SET is_product = 1, uses_platform_collection_gl = 0, type = 'REVENUE', updated_at = NOW()
WHERE id = 'e1b2c3d4-2003-4000-8000-000000000303';

UPDATE account SET is_product = 1, uses_platform_collection_gl = 0, type = 'REVENUE', updated_at = NOW()
WHERE id = 'e1b2c3d4-2002-4000-8000-000000000302';

UPDATE account SET is_product = 0, uses_platform_collection_gl = 0, type = 'CURRENT_ASSET', updated_at = NOW()
...
UPDATE account SET is_product = 0, uses_platform_collection_gl = 0, type = 'CURRENT_LIABILITY', updated_at = NOW()
...
UPDATE account SET is_product = 0, uses_platform_collection_gl = 0, type = 'BANK', updated_at = NOW()
WHERE id = '1c7e41b6-9d57-4c03-8122-a76baad3b592';

UPDATE account SET is_product = 1, uses_platform_collection_gl = 0, type = 'CURRENT_LIABILITY', updated_at = NOW()
...
VALUES ('e053b254-5a3c-4b82-8ba0-fd6d0df231d3', 'Owner Payout', 'EXPENSE', 1, 1, NULL, NOW(), NOW())
