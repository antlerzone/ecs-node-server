...
const create_goods_received_note_schema = joi.object({
...
const update_goods_received_note_schema = create_goods_received_note_schema.keys({
  number: joi.string().max(50).required()
});

const list_goods_received_note_schema = joi.object({
...
const update_goods_received_note_status_schema = joi.object({
