...
module.exports = {
  create_banking_income_schema: createSchema,
  update_banking_income_schema: updateSchema,
  list_banking_income_schema: listSchema,
  update_banking_income_status_schema: updateStatusSchema
};
