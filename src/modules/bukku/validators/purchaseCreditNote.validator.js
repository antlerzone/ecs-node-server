...
const create_purchase_credit_note_schema = joi.object({
...
const update_purchase_credit_note_schema = create_purchase_credit_note_schema.keys({
  number: joi.string().max(50).required()
});

const list_purchase_credit_note_schema = joi.object({
...
const update_purchase_credit_note_status_schema = joi.object({
