...
const { runDailyTenancyCheck, syncRoomAvailableFromTenancy } = require('./tenancy-active.service');
...
/** POST /api/cron/daily — 每日一次：1) 欠租 2) 房间可租同步 3) refunddeposit 4) pricing plan 到期→inactive 5) core credit 到期日清空+写 creditlogs 6) 每月1号 active room 扣费 7) Stripe 8) 门锁电量→feedback */
