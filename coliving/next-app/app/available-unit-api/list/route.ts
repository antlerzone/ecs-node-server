 ...
 * Path is under /available-unit-api/ (not /api/) so Nginx "location /" sends it to Next.
 * Proxies POST to ECS /api/availableunit/list. No subdomain = all operators' units.
 */
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error("[available-unit-api/list]", err);
